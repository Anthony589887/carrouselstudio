...
export const SITUATIONS: DictEntry[] = [
  ...
  },
  {
    ...
    tags: { lighting: "daylight-natural", energy: "low", social: "alone", space: "indoor-public", gender: "neutral" },
  },
  {
    id: "cafe-with-friend",
  ...
  },
  {
    ...
    tags: { lighting: "fluorescent", energy: "high", social: "alone", space: "indoor-public", gender: "neutral" },
  },
  {
  ...
  // === MISC HIGH-INTERIORITY ===
  {
    ...
    tags: { lighting: "dim-cool", energy: "low", social: "alone", space: "indoor-private", gender: "neutral" },
  },
  {
  ...
  // === PARTY / NIGHT OUT ===
  {
    ...
    tags: { lighting: "dim-warm", energy: "high", social: "with-others", space: "indoor-private", gender: "neutral" },
  },
  {
  ...
  // === ROAD TRIP / CAR ===
  {
    ...
    tags: { lighting: "daylight-natural", energy: "low", social: "alone", space: "transit", gender: "neutral" },
  },
  {
...
export function pickCompatibleCombination(args: {
  ...
  const { filters, personaGender } = args;
  ...
  const genderEmotions = EMOTIONAL_STATES.filter((e) =>
    genderPasses(e, personaGender),
  );
